...
UINT8 COE_ServiceInd(TCOEMBX MBXMEM *pCoeMbx)
{
    ...
    case COESERVICE_SDOREQUEST:
        ...
        if(IS_TEST_ACTIVE(EmergencyOnSdoRequest_Test) && ((bEcatInputUpdateRunning && !bEcatOutputUpdateRunning) || (bMbxRunning && !bEcatInputUpdateRunning)))
        {
