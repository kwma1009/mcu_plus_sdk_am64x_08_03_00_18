...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    UINT16 Sdo[2]; /**< \brief 32Bit SDO header buffer*/
            ...
            #define     SDOHEADER_COMMANDMASK               0xFF00 /**< \brief Mask to get the command Byte*/
            #define     SDOHEADER_COMMANDSHIFT              8 /***< \brief Shift to get the command byte*/
            ...
            #define     SDOHEADER_INDEXHIMASK               0xFF00 /**< \brief Mask to get the high byte of the object index*/
            #define     SDOHEADER_SUBINDEXSHIFT             0 /**< \brief Shift to get the subindex*/
            #define     SDOHEADER_SUBINDEXMASK              0x00FF /**< \brief Mask to get the subindex*/
#else
            #define     SDOHEADER_COMMANDOFFSET             0 /**< \brief Memory offset for the command*/
            #define     SDOHEADER_INDEXLOOFFSET             0 /**< \brief Memory offset for the low Byte of the object index*/
            #define     SDOHEADER_INDEXHIOFFSET             1 /**< \brief Memory offset for the high Byte of the object index*/
...
#if BIG_ENDIAN_16BIT
            #define     SDOHEADER_COMMANDOFFSET             1 /**< \brief Memory offset for the command*/
            #define     SDOHEADER_INDEXLOOFFSET             0 /**< \brief Memory offset for the low Byte of the object index*/
            #define     SDOHEADER_INDEXHIOFFSET             3 /**< \brief Memory offset for the high Byte of the object index*/
            #define     SDOHEADER_SUBINDEXOFFSET            2 /**< \brief Memory offset for subindex*/
#else
            #define     SDOHEADER_COMMANDOFFSET             0 /**< \brief Memory offset for the command*/
...
#if BIG_ENDIAN_FORMAT
#define    SEGHEADER_MASK                    ((UINT16) 0xFF00) /**< \brief SDO header mask*/
#define    SEGHEADER_NOMOREFOLLOWS           ((UINT16) 0x0100) /**< \brief More segments follow flag*/
#define    SEGHEADER_SEGDATASIZE             ((UINT16) 0x0E00) /**< \brief Segmented data size*/
#define    SEGHEADER_TOGGLE                  ((UINT16) 0x1000) /**< \brief Toogle flag*/
#define    SEGHEADER_COMMAND                 ((UINT16) 0xE000) /**< \brief Command identifier*/
#define    SEGHEADERSHIFT_SEGDATASIZE        ((UINT16) 9) /**< \brief Shift for Segmented data size*/
#define    SEGHEADERSHIFT_TOGGLE             ((UINT16) 12) /**< \brief Shift for toggle flag*/
#define    SEGHEADERSHIFT_COMMAND            ((UINT16) 12) /**< \brief Shift for command identifier*/
#define    SEGHDATA_MASK                     ((UINT16) 0x00FF) /**< \brief Data mask*/
#define    SEGDATASHIFT                      ((UINT16) 0) /**< \brief Shift for first data Byte*/
#else
...
#if BIG_ENDIAN_FORMAT
        #define     ENTRY_MASK_SUBINDEX     0xFF00 /**< \brief Subindex mask*/
        #define     ENTRY_SUBINDEX_SHIFT    8 /**< \brief Subindex shift*/
        #define     ENTRY_MASK_VALUEINFO    0x00FF /**< \brief Value info mask*/
        #define     ENTRY_VALUEINFO_SHIFT   0 /**< \brief Value info shift*/
#else
...
typedef struct MBX_STRUCT_PACKED_START
{
    ...
    #if BIG_ENDIAN_FORMAT
        #define     INFOHEAD_OPCODE_MASK            0x7F00 /**< \brief Opcode mask*/
        #define     INFOHEAD_OPCODE_SHIFT           8 /**< \brief Opcode shift*/
        #define     INFOHEADER_INCOMPLETE_MASK      0x8000 /**< \brief Incomplete mask*/
        #define     INFOHEADER_INCOMPLETE_SHIFT     8 /**< \brief Incomplete shift, the incomplete value "SDOINFOSERVICE_INCOMPLETE" is defined as a UINT8 => shift only one byte*/
    #else
...
#endif
#if SDO_RES_INTERFACE || SEGMENTED_SDO_SUPPORTED
