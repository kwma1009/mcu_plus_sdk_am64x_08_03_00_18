...
#define DIAG_CREATE_PARAM_FLAG(type,info)   ((UINT32)((((UINT16)(type))<<(DIAG_MSG_PARAM_TYPE_OFFSET)) | ((UINT16)(info)))) /**< \brief Macro merge "type" and "info" in message header*/


/*Defined Diagnosis Codes*/
#define DIAG_CODE_EMCY(Code)        (((UINT32)(Code))<< 16 | (UINT16)(0xE800)) /**< \brief Macro to create emergency code*/
...
/*Add new message results*/
#define DIAG_MESSAGE_ADDED              0x00
#define DIAG_NO_MESSAGE_MEMORY          0x01
#define DIAG_MESSAGE_DISCRAD            0x02
...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   UINT8    u8MaximumMessages; /**< \brief Maximum Number of messages (SI 1)*/
   UINT8    u8NewestMessage; /**< \brief Newest message (SI 2)*/
   UINT8    u8NewestAckMessage; /**< \brief Newest acknowledged message (SI 3)*/
   UINT8    u8NewMessage; /**< \brief New Message (SI 4)*/
 ...
 */
OBJCONST UCHAR OBJMEM aName0x10F3[] = "Diagnosis History\000Maximum Messages\000Newest Message\000Newest Acknowledged Message\000New Messages Available\000Flags\000Diagnosis Message\000\377";
#endif
...
/*ECATCHANGE_START(V5.13) DIAG1*/
PROTO UINT8 Diag_CreateNewMessage(UINT32 DiagCode,UINT8 Type,UINT16 TextID,UINT8 NumParam, TDIAGMSGPARAMINFO *pParam);
/*ECATCHANGE_END(V5.13) DIAG1*/
