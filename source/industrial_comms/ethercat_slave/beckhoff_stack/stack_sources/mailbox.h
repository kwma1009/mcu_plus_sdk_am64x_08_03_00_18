...
#if !MAILBOX_QUEUE
PROTO BOOL                    bPendingMbxResponse;   /**indicates if a Mbox is pending (in case that no mailbox queue is supported only one mailbox request after the other shall be handled)*/
#endif
#if MAILBOX_QUEUE
