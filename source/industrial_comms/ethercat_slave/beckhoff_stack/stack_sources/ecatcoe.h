...
#define     COEHEADER_COESERVICESHIFT   4 /**< \brief CoE service shift (within CoE header)*/
#define     COEHEADER_COESERVICEMASK    0x00F0 /**< \brief CoE service mask (within CoE header)*/
#else
